function [P,J]=Snake2D(I,P,Options,movie_name)
...
% Process inputs
defaultoptions=struct('Verbose',false,'nPoints',100,'Wline',.04,'Wedge',2,'Wterm',0.01,'Sigma1',1,'Sigma2',2,'Alpha',0.2,'Beta',0.2,'Delta',0.1,'Gamma',1,'Kappa',2,'Iterations',100,'GIterations',0,'Mu',0.2,'Sigma3',1);
...
% aviobj = avifile(movie_name,'fps',2,'quality',100);
